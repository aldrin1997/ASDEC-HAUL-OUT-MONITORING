...
function App({ user, onLogout }) {
  ...
  const [view, setView] = useState('form'); // Toggle between 'form' and 'history'
  const [submittedReports, setSubmittedReports] = useState([]); // Local history storage
  ...
  // Fixed: Improved state update to prevent input focus loss
